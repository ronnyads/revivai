...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    nodes: [
      ...
      { type: 'video', x: 1260, y: 100, params: { source_image_url: '', motion_prompt: 'camera suave e natural', duration: 8 } },
      { type: 'video', x: 1260, y: 560, params: { source_image_url: '', motion_prompt: 'zoom in no rosto', duration: 8 } },
      { type: 'video', x: 1260, y: 1020, params: { source_image_url: '', motion_prompt: 'gesticula levemente', duration: 8 } },
      { type: 'video', x: 1260, y: 1480, params: { source_image_url: '', motion_prompt: 'sorriso de confianca', duration: 8 } },
      { type: 'video', x: 1260, y: 1940, params: { source_image_url: '', motion_prompt: 'mostrando o ambiente ao redor', duration: 8 } },
      { type: 'video', x: 1260, y: 2400, params: { source_image_url: '', motion_prompt: 'apontando para baixo', duration: 8 } },
  ...
  },
  {
    ...
    nodes: [
      ...
      { type: 'video', x: 1260, y: 280, params: { source_image_url: '', motion_prompt: 'movimento suave, exibe produto com confianca', duration: 8 } },
