...
const STUDIO_PLANS = [
  {
    ...
    capabilities: [
      { label: 'Imagens Premium', count: 75, unit: 'imagens' },
      { label: 'Vídeos Padrão', count: 40, unit: 'vídeos' },
      { label: 'Vídeos com Fala', count: 6, unit: 'vídeos' },
      { label: 'Vozes / Áudios', count: 200, unit: 'áudios' },
      { label: 'Scripts IA', count: 200, unit: 'scripts' },
