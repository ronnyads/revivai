export default function Testimonials() {
  const reviews = [
    { initials:'MA', name:'Maria Aparecida', role:'Cliente desde 2024', quote:'Restaurei fotos da minha avó de 1960. Fiquei em lágrimas com o resultado. A qualidade é impressionante.' },
    { initials:'RP', name:'Ricardo Pimentel', role:'Fotógrafo profissional', quote:'Fotógrafo profissional aqui. Uso o reviv.ai para restaurar acervos de clientes. A colorização é absurdamente boa.' },
    { initials:'CS', name:'Carla Souza', role:'Designer gráfica', quote:'Rapidez e qualidade que não encontrei em nenhum outro serviço. Vale cada centavo do pacote anual.' },
  ]
    ...
    <section id="depoimentos" className="bg-surface py-28">
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {reviews.map(r => (
            <div key={r.name} className="bg-white rounded-xl p-9 border border-[#E8E8E8] hover:-translate-y-0.5 transition-transform duration-300">
