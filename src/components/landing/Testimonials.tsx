          ...
          {TESTIMONIALS.map((t, idx) => (
            <div key={idx} className="bg-[#131315] p-12 hover:bg-white/[0.02] transition-all duration-700 flex flex-col justify-between relative group overflow-hidden cursor-default">
              ...
              <div className="relative z-10">
                 <div className="flex gap-1 text-[#D4FF00] mb-8 group-hover:drop-shadow-[0_0_8px_rgba(212,255,0,0.4)] transition-all duration-700">
                   {[1, 2, 3, 4, 5].map(star => (
              ...
              <div className="relative z-10">
                 ...
                 <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/30 group-hover:text-[#D4FF00]/60 transition-colors duration-700">{t.role}</p>
              </div>
            </div>
          ))}
        </div>
