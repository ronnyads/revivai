...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white selection:bg-[#7C0DF2] selection:text-[#020617] font-sans antialiased">
      {/* Mobile Sidebar */}
      <MobileSidebar />
        ...
        <aside className="hidden lg:flex w-72 flex-col fixed inset-y-0 border-r border-white/5 bg-[#0F172A]/50 backdrop-blur-xl z-20">
          <div className="p-8 border-b border-white/5">
            <h1 className="text-2xl font-bold tracking-tighter text-white font-display uppercase flex items-center gap-2">
              <span className="w-4 h-4 bg-[#7C0DF2]" />
              Reviv.ai
            </h1>
          ...
          <div className="mt-auto p-8 border-t border-white/5">
            <div className="bg-[#1E293B] border border-white/10 p-4 rounded-lg flex flex-col gap-2 relative overflow-hidden group">
               <div className="absolute top-0 right-0 w-24 h-24 bg-[#7C0DF2] opacity-5 blur-2xl group-hover:opacity-20 transition-opacity" />
               ...
               <div className="flex justify-between items-center text-sm">
                 ...
                 <span className="text-[#7C0DF2] font-bold font-mono">942</span>
               </div>
               <div className="w-full h-1 bg-black/50 mt-1 rounded-full overflow-hidden">
                 <div className="h-full bg-[#7C0DF2] w-3/4 rounded-full" />
               </div>
            </div>
          </div>
        </aside>
