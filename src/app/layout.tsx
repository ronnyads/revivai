  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        {/* Newsreader — optional: never blocks render; uses Georgia fallback on first visit */}
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Newsreader:ital,opsz,wght@1,48,400&display=optional" />
