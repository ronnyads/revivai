      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input name="stat_photos" defaultValue={photos} placeholder="48000"
            className="w-full bg-white/[0.05] border border-white/[0.08] rounded-lg px-3 py-2.5 text-sm text-white font-mono focus:outline-none focus:border-[#7C0DF2]/60 transition-colors placeholder:text-white/20" />
        </div>
        <div>
