...
export function resolveStudioAssetEnginePolicy(params: {
  ...
  const baseByType: Record<AssetType, StudioAssetEnginePolicy> = {
    image: {
      ...
      runtimeModel: 'imagen-3.0-generate-001',
    ...
    video: {
      ...
      runtimeModel: 'veo_vertex_publisher_model',
      targetEngine: 'vertex_veo',
      targetModel: 'veo_vertex_publisher_model',
      parityStatus: 'ready',
      legacyFallbackAllowed: legacyAllowed,
      legacyFallbackUsed: false,
    },
    talking_video: {
      ...
      runtimeModel: talkingMode === 'veo_natural' ? 'veo_vertex_publisher_model' : 'lipsync_pending_google_migration',
      targetEngine: 'vertex_veo',
      targetModel: 'veo_vertex_publisher_model',
    ...
    model: {
      ...
      runtimeEngine: 'vertex_imagen_generate',
      runtimeModel: 'gemini-2.5-flash + imagen-3.0-generate-001',
      targetEngine: 'vertex_imagen_generate',
      targetModel: 'gemini-2.5-flash + imagen-3.0-generate-001',
      parityStatus: 'ready',
      legacyFallbackAllowed: legacyAllowed,
      legacyFallbackUsed: false,
    },
    ...
    angles: {
      assetType: 'angles',
      providerFamily: 'google_cloud',
      billingRoute: 'vertex_imagen_edit_pending',
      runtimeEngine: 'vertex_imagen_edit_pending',
      runtimeModel: 'angles_mapping_pending',
      targetEngine: 'vertex_imagen_edit',
      targetModel: 'imagen_capability_reference_edit',
      parityStatus: 'gap',
      legacyFallbackAllowed: legacyAllowed,
      legacyFallbackUsed: false,
      reasonCode: 'parity_gap_requires_migration',
      notes: 'Angles ainda dependia de Gemini image preview/Fal image-to-image.',
    },
    music: {
      assetType: 'music',
      providerFamily: 'google_cloud',
